...
def main():
    ...
    # Definir los puntos de la pirámide
    apex = (0, 5, 0)  # Punto superior
    base_points = [
            ...
            if event.type == pygame.QUIT:
                ...
                if mouse_button_pressed:
                    ...
                    if last_mouse_pos:
                        ...
                        # Actualizar rotación
                        rotation_x += dy * 0.5  # Rotación vertical
                        rotation_y += dx * 0.5  # Rotación horizontal
                        
                        # Aplicar rotaciones
                        glRotatef(dy * 0.5, 1, 0, 0)  # Rotación en X
                        glRotatef(dx * 0.5, 0, 1, 0)  # Rotación en Y
